...
//
//     final updateBusinessRp = updateBusinessRpFromJson(jsonString);
  ...
  UpdateBusinessRp copyWith({
    ...
    BusinessSetting? businessSetting,
      ...
      UpdateBusinessRp(
        ...
        businessSetting: businessSetting ?? this.businessSetting,
      );

  factory UpdateBusinessRp.fromRawJson(String str) =>
      UpdateBusinessRp.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory UpdateBusinessRp.fromJson(Map<String, dynamic> json) =>
      UpdateBusinessRp(
        success: json["success"],
        message: json["message"],
        businessSetting: json["business_setting"] == null
            ? null
            : BusinessSetting.fromJson(json["business_setting"]),
      );

  Map<String, dynamic> toJson() => {
        "success": success,
        "message": message,
        "business_setting": businessSetting?.toJson(),
      };
}
...
class BusinessSetting {
  ...
  factory BusinessSetting.fromRawJson(String str) =>
      BusinessSetting.fromJson(json.decode(str));
  ...
  factory BusinessSetting.fromJson(Map<String, dynamic> json) =>
      BusinessSetting(
        header:
            json["headers"] == null ? null : Header.fromJson(json["headers"]),
...
class CommissionAgent {
  String? salesCommissionAgent;
  dynamic commissionCalculationType;
