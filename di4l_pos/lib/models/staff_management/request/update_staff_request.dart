...
class UpdateStaffRequest {
  ...
  factory UpdateStaffRequest.fromRawJson(String str) =>
      UpdateStaffRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory UpdateStaffRequest.fromJson(Map<String, dynamic> json) => UpdateStaffRequest(
