...
class AddSellRequest {
  List<SellRequest>? sells;
  AddSellRequest({
    this.sells,
  });
  AddSellRequest.fromJson(Map<String, dynamic> json) {
    if (json['sells'] != null) {
      sells = <SellRequest>[];
  ...
  factory AddSellRequest.fromRawJson(String str) =>
      AddSellRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(sells);

  // factory AddSellRequest.fromJson(Map<String, dynamic> json) => AddSellRequest(
  //       sells: json["sells"] == null
  //           ? null
  //           : List<SellRequest>.from(
  //               json["sells"].map((x) => SellRequest.fromJson(x))),
  //     );
