...
class SelectProductTransfer extends StatefulWidget {
  const SelectProductTransfer({
    this.selectedItems,
    required this.onTap,
    Key? key,
    required this.isShowButton,
    required this.selectModeAddStockTransfer,
  }) : super(key: key);

  final List<dynamic>? selectedItems;
  final CategoryCallback onTap;
  final bool isShowButton;
  final SelectModeAddStockTransfer selectModeAddStockTransfer;

  @override
  State<SelectProductTransfer> createState() => _SelectProductTransferState();
}

class _SelectProductTransferState extends State<SelectProductTransfer> {
  List<Product> selectedItems = [];

  @override
  void initState() {
    super.initState();
    switch (widget.selectModeAddStockTransfer) {
      case SelectModeAddStockTransfer.product:
        {
