...
class _AddStockAdjustmentScreenState extends State<AddStockAdjustmentScreen>
  ...
  // final List<TextEditingController> _txtSubTotal = [];
  ...
  String selectedOptionType = 'normal'.tr;
        ...
        onPressed: () {
          ...
          _globalKey.currentContext!
              ...
              .addStockAdjustment(
                ...
                totalAmountRecovered: _txttotalAmountRecovered.text.trim(),
  ...
  //   return BlocBuilder<AddStockAdjustmentCubit, AddStockAdjustmentState>(
  //     builder: (context, state) {
  //       _txtTotalAmount.text =
  //           GlobalFormatter.formatNumber(source: state.data!.sum);
  //       return Column(
  //         crossAxisAlignment: CrossAxisAlignment.start,
  //         children: [
  //           Padding(
  ...
  Column buildTotalAmountRecovered() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  BlocBuilder<BusinessCubit, BusinessState> buildBusinessLocation() {
