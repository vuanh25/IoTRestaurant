...
class FundTransferScreen extends StatefulWidget {
  ...
  const FundTransferScreen({Key? key, this.paymentAccount}) : super(key: key);
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                context.read<PaymentAccountsCubit>().fundTransfer(
                    fromAccount: _paymentAccountFromId.toString(),
                    toAccount: _paymentAccountToId.toString(),
