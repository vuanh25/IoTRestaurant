...
import 'widgets/dialog_filter.dart';
import '../widgets/product_gridview_widget.dart';
import '../../unit_screen/cubit/unit_cubit.dart';
import '../../order_screen/order_screen.dart';

class SelectProductForOder extends StatefulWidget {
  const SelectProductForOder({Key? key}) : super(key: key);
  static MultiBlocProvider provider() {
    return MultiBlocProvider(
      ...
      child: const SelectProductForOder(),
    );
  }

  @override
  State<SelectProductForOder> createState() => _SelectProductForOderState();
}

class _SelectProductForOderState extends State<SelectProductForOder> {
  @override
  void initState() {
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: InkWell(
                                onTap: () => navigator!
                                    .pushNamed(
                                        RouteGenerator.addOrderDetailScreen,
                                        arguments: state.data!.productsSelected)
                                    .then((value) {
                                  // if (value is Map<Product, int>) {
                                  //   context
                                  //       .read<ProductsCubit>()
                                  //       .setProductSSelectAll(value);
                                  // }
                                }),
                                child: Container(
